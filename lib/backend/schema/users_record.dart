...
class UsersRecord extends FirestoreRecord {
  ...
  // "GeneroDesejado" field.
  String? _generoDesejado;
  String get generoDesejado => _generoDesejado ?? '';
  bool hasGeneroDesejado() => _generoDesejado != null;
  ...
  void _initializeFields() {
    ...
    _generoDesejado = snapshotData['GeneroDesejado'] as String?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.genero == e2?.genero &&
        e1?.generoDesejado == e2?.generoDesejado;
  }
